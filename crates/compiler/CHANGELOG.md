...
## [0.0.1](https://github.com/callqh/farm/releases/tag/farmfe_compiler-v0.0.1) - 2024-03-12
...
- Support js plugin hook context methods for unplugin ([#589](https://github.com/callqh/farm/pull/589))
...
- *(watch)* WIP add watch command ([#313](https://github.com/callqh/farm/pull/313))
...
- queue async update and wait for compiling to finish when refresh ([#97](https://github.com/callqh/farm/pull/97))
...
- add load and transform hook for js plugins ([#58](https://github.com/callqh/farm/pull/58))
...
- setup node binding and tests ([#8](https://github.com/callqh/farm/pull/8))
...
- [#850](https://github.com/callqh/farm/pull/850) ([#870](https://github.com/callqh/farm/pull/870))
- error logging and remove process exit ([#852](https://github.com/callqh/farm/pull/852))
...
- [#768](https://github.com/callqh/farm/pull/768) ([#771](https://github.com/callqh/farm/pull/771))
...
- css resource cannot find sourcemap ([#714](https://github.com/callqh/farm/pull/714))
...
- HMR update fail when there are deep dependencies changed ([#619](https://github.com/callqh/farm/pull/619))
...
- hmr patch ([#443](https://github.com/callqh/farm/pull/443))
...
- hmr remove dependency ([#405](https://github.com/callqh/farm/pull/405))
- *(WIP)* resolve module_graph  error ([#355](https://github.com/callqh/farm/pull/355))
...
- coverage ci ([#176](https://github.com/callqh/farm/pull/176))
...
- switch to chokidar ([#886](https://github.com/callqh/farm/pull/886))
...
- optimize cache 4 ([#820](https://github.com/callqh/farm/pull/820))
- optimize cache 3 ([#786](https://github.com/callqh/farm/pull/786))
- optimize cache 2 ([#785](https://github.com/callqh/farm/pull/785))
...
- Fix/css hmr ([#419](https://github.com/callqh/farm/pull/419))
...
- support sync option when update ([#315](https://github.com/callqh/farm/pull/315))
...
- Optimization process error message ([#172](https://github.com/callqh/farm/pull/172))
